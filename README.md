...
A simple boilerplate for Front-end web development, Sass and Flexbox.
...
Frontend-sass comes with a collection of Sass mixins that are often used and needed in order to follow DRY principle.
